<script setup> 
    import { Selectors } from '@data/cssData.js'       
...
<Mtable :head=head :data=类型选择器 :linkUrl=baseCssUrl></Mtable>    
...
<Mtable :head=head :data=全局选择器 :linkUrl=baseCssUrl></Mtable>    
...
<Mtable :head=head :data=类选择器 :linkUrl=baseCssUrl></Mtable>    
...
<Mtable :head=head :data=ID选择器 :linkUrl=baseCssUrl></Mtable>    
...
<Mtable :head=head :data=存否和值选择器 :linkUrl=baseCssUrl></Mtable>   
...
<Mtable :head=head :data=子字符串匹配选择器 :linkUrl=baseCssUrl></Mtable>    
...
下面以列表的形式列举了一些常见的伪类。   
<Mtable :head=head :data=伪类 :linkUrl=baseCssUrl></Mtable>      
...
下面以列表的形式列举了一些常见的伪元素。          
<Mtable :head=head :data=伪元素 :linkUrl=baseCssUrl></Mtable>  
...
<Mtable :head=head :data=后代选择器 :linkUrl=baseCssUrl></Mtable>
...
<Mtable :head=head :data=子代关系选择器 :linkUrl=baseCssUrl></Mtable>
...
<Mtable :head=head :data=相邻兄弟选择器 :linkUrl=baseCssUrl></Mtable>
...
<Mtable :head=head :data=通用兄弟选择器 :linkUrl=baseCssUrl></Mtable>
...
<Mtable :head=head :data=选择器列表 :linkUrl=baseCssUrl></Mtable>
